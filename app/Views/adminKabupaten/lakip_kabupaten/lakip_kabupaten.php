                ...
                <table class="table table-bordered table-striped text-center small">
                    <thead class="table-success align-middle text-center">
                        <tr>
                            ...
                            <th class="border p-2 align-middle" rowspan="2">STATUS</th>
                            <th class="border p-2 align-middle" rowspan="2">TANGGAL UPLOAD</th>
                            <th class="border p-2 align-middle" rowspan="2">FILE</th>
                            <th class="border p-2 align-middle" rowspan="2">ACTION</th>
                        </tr>
                        <tr>
