...
<head>
  ...
  <title>Tambah IKU e-SAKIP</title>
  <!-- Style -->
          ...
          <div id="sasaran-iku-container">
            ...
            <div class="sasaran-iku-item bg-light border rounded p-3 mb-3">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button type="button" class="remove-sasaran-iku btn btn-outline-danger btn-sm"><i
              ...
              <div class="row mb-3">
                <div class="col-md-12">
                  ...
                  <textarea name="sasaran_iku[0][sasaran]" class="form-control" rows="2"
                    placeholder="Masukkan sasaran IKU" required></textarea>
                </div>
              </div>
                ...
                <div class="indikator-kinerja-container">
                  ...
                  <div class="indikator-kinerja-item border rounded p-3 bg-white mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <button type="button" class="remove-indikator-kinerja btn btn-outline-danger btn-sm"><i
                          class="fas fa-trash"></i></button>
                    </div>

                    <div class="mb-3">
                      <label class="form-label">Indikator Kinerja</label>
                      <textarea name="sasaran_iku[0][indikator_kinerja][0][indikator_kinerja]" class="form-control"
                        rows="2" placeholder="Masukkan indikator kinerja" required></textarea>
                    </div>

                    <div class="mb-3">
                      <label class="form-label">Definisi & Formulasi</label>
                      <textarea name="sasaran_iku[0][indikator_kinerja][0][definisi_formulasi]" class="form-control"
                        rows="3" placeholder="Masukkan definisi dan formulasi indikator" required></textarea>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <textarea name="sasaran_iku[0][indikator_kinerja][0][program_pendukung]" class="form-control"
                          rows="2" placeholder="Masukkan program pendukung" required></textarea>
                      </div>
                    </div>
                    ...
                    <div class="target-section">
                      ...
                      <div class="target-container">
                        <div class="target-item row g-2 align-items-center mb-2">
                          <div class="col-auto">
                            <input type="number" name="sasaran_iku[0][indikator_kinerja][0][target_tahunan][0][tahun]"
                              value="2025" class="form-control form-control-sm" style="width: 80px;" placeholder="Tahun"
                              required>
                          </div>
                          <div class="col">
                            <input type="text" name="sasaran_iku[0][indikator_kinerja][0][target_tahunan][0][target]"
                              class="form-control form-control-sm" placeholder="Target" required>
                          </div>
                          <div class="col-auto">
                            <button type="button" class="remove-target btn btn-outline-danger btn-sm"><i
