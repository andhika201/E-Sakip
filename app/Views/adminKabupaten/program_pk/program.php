        ...
        <main class="flex-fill p-4 mt-2">
            <div class="bg-white rounded shadow p-4">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between gap-3 mb-4">
                    ...
                    <div class="d-flex gap-2 programpk-actions">
                        <a href="<?= base_url('adminkab/program_pk/tambah') ?>"
                            class="btn btn-success d-flex align-items-center">
                            <i class="fas fa-plus me-1"></i> TAMBAH
                        </a>
                        <a href="<?= base_url('adminkab/program_pk/import') ?>"
                            class="btn btn-warning d-flex align-items-center">
                            <i class="fas fa-file me-1"></i> Import
                        </a>
                    </div>
                </div>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="4" class="border p-3 text-muted">
                                        <i class="fas fa-info-circle me-2"></i>Belum ada data program PK. <a
                                            href="<?= base_url('adminkab/program_pk/tambah') ?>" class="text-success">Tambah
                                            data pertama</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
