          ...
          <div class="col-12 col-lg-7">
            <div class="panel">
              <div class="panel-head">
                ...
                <?php if (in_array((string) session()->get('role'), ['admin_kab', 'admin'], true)): ?>
                  <a href="<?= base_url('adminkab/dashboard/capaian-historis') ?>" class="btn btn-sm btn-outline-success">
                    <i class="fas fa-pen-to-square me-1"></i> Input tahun sebelumnya
                  </a>
                <?php endif; ?>
              </div>
