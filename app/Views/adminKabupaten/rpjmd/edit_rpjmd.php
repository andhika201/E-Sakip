      ...
      <section class="mb-4">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <textarea name="misi_rpjmd" class="form-control mb-3" rows="2" required>Menciptakan kehidupan yang religius (agamIs), berbudaya, aman dan damai.</textarea>
          </div>
          <div class="col-md-2">
            <label class="form-label">Periode Mulai</label>
            <input type="number" name="periode_start" class="form-control mb-3" value="2019" placeholder="Tahun" required>
          </div>
          <div class="col-md-2">
            <label class="form-label">Periode Akhir</label>
            <input type="number" name="periode_end" class="form-control mb-3" value="2024" placeholder="Tahun" required>
          </div>
        </div>
      </section>
        ...
        <div id="tujuan-container">
          ...
          <div class="tujuan-item bg-light border rounded p-3 mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea name="tujuan[0][tujuan_rpjmd]" class="form-control" rows="2" required>Terwujudnya kehidupan masyarakat yang agamis, berbudaya dan demokratis</textarea>
            </div>
              ...
              <div class="sasaran-container">
                ...
                <div class="sasaran-item border rounded p-3 bg-white mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="tujuan[0][sasaran][0][sasaran_rpjmd]" class="form-control" rows="2" required>Meningkatkan kualitas kehidupan beragama dan toleransi antar umat beragama</textarea>
                  </div>
                    ...
                    <div class="indikator-sasaran-container">
                      ...
                      <div class="indikator-sasaran-item border rounded p-3 bg-light mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <textarea name="tujuan[0][sasaran][0][indikator_sasaran][0][strategi]" class="form-control mb-3" rows="3" placeholder="Masukkan strategi untuk mencapai indikator sasaran" required>Meningkatkan fasilitas tempat ibadah dan pembinaan kegiatan keagamaan</textarea>
                        </div>
