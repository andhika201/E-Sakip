                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <select name="pegawai_1_id" id="p1_select"
                                        class="form-select mb-3 border-secondary pegawai-select" data-target="nip-p1"
                                        required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="nip-p1" class="form-control mb-3 border-secondary" value=""
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <select name="pegawai_2_id" id="p2_select"
                                        class="form-select mb-3 border-secondary pegawai-select" data-target="nip-p2"
                                        required>
                                        <option value="">Pilih Pihak Kesatu</option>
                                        <?php if (isset($pegawaiOpd) && !empty($pegawaiOpd)): ?>
                                            <?php foreach ($pegawaiOpd as $pegawai): ?>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label">NIP Pegawai</label>
                                    <input type="text" name="nip-p2" class="form-control mb-3 border-secondary" value=""
                                        placeholder="NIP" required readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <select name="program[0][program_id]" class="form-select program-select mb-3"
                                            required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="program[0][anggaran]"
                                            class="form-control mb-3 border-secondary" value="" placeholder="Anggaran"
                                            required readonly>
                                    </div>
                                </div>
                            </div>
