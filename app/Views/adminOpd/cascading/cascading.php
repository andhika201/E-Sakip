                                ...
                                for ($index = 0; $index < $rowCount; $index++):
                                    ...
                                    if ($k2 !== $curK2) {
                                        $rs2 = $calcRowspan(
                                            $renstra_data,
                                            $index,
                                            fn($x) => (($x['sasaran_rpjmd'] ?? '') . '|' . ($x['tujuan_renstra'] ?? ''))
                                        );
                                        $curK2 = $k2;
                                    } else {
                                        $rs2 = 0;
                                    ...
                                    if ($k3 !== $curK3) {
                                        $rs3 = $calcRowspan(
                                            $renstra_data,
                                            $index,
                                            fn($x) => (($x['sasaran_rpjmd'] ?? '') . '|' . ($x['tujuan_renstra'] ?? '') . '|' . ($x['indikator_tujuan'] ?? ''))
                                        );
                                        $curK3 = $k3;
                                    } else {
                                        $rs3 = 0;
                                    ...
                                    if ($k4 !== $curK4) {
                                        $rs4 = $calcRowspan(
                                            $renstra_data,
                                            $index,
                                            fn($x) => (($x['sasaran_rpjmd'] ?? '') . '|' . ($x['tujuan_renstra'] ?? '') . '|' . ($x['indikator_tujuan'] ?? '') . '|' . ($x['sasaran'] ?? ''))
                                        );
                                        $curK4 = $k4;
                                    } else {
                                        $rs4 = 0;
