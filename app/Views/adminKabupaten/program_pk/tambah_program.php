...
<body class="bg-light min-vh-100 d-flex flex-column position-relative">
  ...
  <main class="flex-fill d-flex justify-content-center p-4 mt-4">
    <div class="bg-white rounded shadow-sm p-4" style="width: 100%; max-width: 1200px;">
      <h2 class="h3 fw-bold text-center mb-4" style="color: #00743e;">Tambah Program PK</h2>
        ...
        <div id="program-pk-container">
          ...
          <div class="program-pk-item bg-light border rounded p-3 mb-3" data-index="0">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <label class="fw-medium h5">Program PK</label>
            </div>
            <div class="row mb-3">
              <div class="col-md-8">
                <label class="form-label">Program Kegiatan</label>
                <textarea name="program_kegiatan" class="form-control border-secondary" rows="3" placeholder="Masukkan Program Kegiatan" required></textarea>
              </div>
              <div class="col-md-4">
    ...
    document.getElementById('program-pk-form').addEventListener('submit', function(e) {
      ...
      items.forEach((item, index) => {
        ...
        if (!anggaran || parseFloat(anggaran) <= 0) {
          alert(`Anggaran Program harus lebih dari 0`);
          isValid = false;
          return;
        }
      });
