            ...
            <div class="program-pk-item bg-light border rounded p-3 mb-3" data-index="0">
              ...
              <div class="row mb-3">
                <div class="col-md-8">
                  ...
                  <textarea name="program_kegiatan" class="form-control border-secondary" rows="3"
                    required><?= old('program_kegiatan', $program['program_kegiatan']) ?></textarea>
                </div>
                <div class="col-md-4">
                  <label class="form-label">Anggaran (Rp)</label>
                  <input type="number" name="anggaran" class="form-control border-secondary" placeholder="0" min="0"
                    step="1000" required value="<?= old('anggaran', $program['anggaran']) ?>">
