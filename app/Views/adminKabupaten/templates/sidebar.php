...
<div id="sidebar" class="sidebar position-fixed top-0 start-0 h-100 d-flex flex-column justify-content-between sidebar-hidden">
  ...
  <nav class="flex-grow-1 px-3 py-4">
    <a href="<?= base_url('adminkab/dashboard') ?>" class="sidebar-link <?= (isset($page) && $page == 'dashboard' ? 'active' : '') ?>">
     ...
     <a href="<?= base_url('adminkab/rpjmd') ?>" class="sidebar-link <?= (isset($page) && $page == 'rpjmd' ? 'active' : '') ?>">
      <i class="fas fa-book me-2"></i> RPJMD Kabupaten
    </a>
   <a href="<?= base_url('adminkab/rkt') ?>" class="sidebar-link <?= (isset($page) && $page == 'rkt' ? 'active' : '') ?>">
      <i class="fas fa-tasks me-2"></i> RKT
    </a>
     <a href="<?= base_url('adminkab/pk_bupati') ?>" class="sidebar-link <?= (isset($page) && $page == 'pk_bupati' ? 'active' : '') ?>">
      <i class="fas fa-file-alt me-2"></i> PK Bupati
    </a>
    <a href="<?= base_url('adminkab/lakip_kabupaten') ?>" class="sidebar-link <?= (isset($page) && $page == 'lakip_kabupaten' ? 'active' : '') ?>">
      <i class="fas fa-chart-line me-2"></i> LAKIP Kabupaten
    </a>
    <a href="<?= base_url('adminkab/tentang_kami') ?>" class="sidebar-link <?= (isset($page) && $page == 'tentang_kami' ? 'active' : '') ?>">
