...
<body class="bg-light min-vh-100 d-flex flex-column position-relative">
  ...
  <main class="flex-fill d-flex justify-content-center p-4 mt-4 row">
    <form id="rpjmd-form" method="POST" action="<?= base_url('adminkab/pk_bupati/save') ?>">
    <?= csrf_field() ?>
    
    <div class="bg-white rounded shadow-sm p-4 mb-4" style="width: 100%; max-width: 1200px;">
        <h2 class="h3 fw-bold text-center mb-4" style="color: #00743e;">Tambah PK Bupati</h2>
          ...
          <div class="col-md-12 mb-3">
            <div class="row col-gap-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="nama_bupati" class="form-control mb-3 border-secondary" placeholder="Masukkan nama Bupati" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Tanggal PK</label>
                    <input type="date" name="tanggal" class="form-control mb-3 border-secondary" required>
                </div>
            </div>
            <div class="col-md-12 mb-3">
                ...
                <select name="rpjmd_misi_id" class="form-select mb-3 border-secondary" required>
                    ...
                    <?php if (isset($misiRpjmd) && !empty($misiRpjmd)): ?>
                        <?php foreach ($misiRpjmd as $misi): ?>
                            <option value="<?= $misi['id'] ?>"><?= esc($misi['misi']) ?></option>
                        <?php endforeach; ?>
                    <?php else: ?>
