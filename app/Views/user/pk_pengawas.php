  ...
  <div class="container-fluid my-4 px-4" >
    <div class="bg-white p-4 rounded shadow-sm">
      ...
      <div class="row justify-content-center mb-4">
        ...
        <div class="col-md-2">
          <button class="btn btn-success w-100" onclick="filterPkPengawas()">
      ...
      <div class="table-responsive">
        <table class="table table-bordered text-center align-middle">
          ...
          <tbody id="pkPengawasTableBody">
            <?php $no = 1; foreach ($pkPengawasData as $item): ?>
...
<script>
  function filterPkPengawas() {
    ...
    const rows = document.querySelectorAll('#pkPengawasTableBody tr');
    rows.forEach(row => {
