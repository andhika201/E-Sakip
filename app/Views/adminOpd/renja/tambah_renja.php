          ...
          <div class="sasaran-renja-item bg-light border rounded p-3 mb-3">
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                ...
                <textarea name="renja_sasaran[0][sasaran]" class="form-control" rows="2" placeholder="Masukkan sasaran RENJA" required></textarea>
              </div>
            </div>
              ...
              <div class="indikator-sasaran-renja-container">
                ...
                <div class="indikator-sasaran-renja-item border rounded p-3 bg-white mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="renja_sasaran[0][indikator_sasaran][0][indikator_sasaran]" class="form-control" rows="2" placeholder="Masukkan indikator sasaran" required></textarea>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="number" name="renja_sasaran[0][indikator_sasaran][0][tahun]" class="form-control" min="2000" max="2100" placeholder="Contoh: 2025" required>
                    </div>
                    <div class="col-md-4">
                      <label class="form-label">Target</label>
                      <input type="text" name="renja_sasaran[0][indikator_sasaran][0][target]" class="form-control" placeholder="Nilai target" required>
                    </div>
                  </div>
    ...
    function addIndikatorSasaranrenja(sasaranElement) {
      ...
      newIndikator.innerHTML = `
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            <label class="form-label">Tahun Target</label>
            <input type="number" class="form-control" min="2000" max="2100" placeholder="Contoh: 2025" required>
          </div>
          <div class="col-md-4">
            <label class="form-label">Target</label>
