...
<head>
    ...
    <title><?= $title ?? 'Edit LAKIP Kabupaten' ?></title>
...
<body class="bg-light min-vh-100 d-flex flex-column position-relative">
  ...
  <main class="flex-fill d-flex justify-content-center p-4 mt-4">
    <div class="bg-white rounded shadow-sm p-4" style="width: 100%; max-width: 1200px;">
      <h2 class="h3 fw-bold text-center mb-4" style="color: #00743e;">Edit LAKIP Kabupaten</h2>

      <form id="lakip-form" method="POST" action="<?= base_url('adminkab/lakip_kabupaten/update/' . ($lakip['id'] ?? '')) ?>" enctype="multipart/form-data">
        <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <?php if (!empty($lakip['file'])): ?>
                    <div class="mb-2">
                        ...
                        <a href="<?= base_url('adminkab/lakip_kabupaten/download/' . $lakip['id']) ?>" class="btn btn-sm btn-outline-primary ms-2">
