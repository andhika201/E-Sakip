    ...
    <main class="flex-fill d-flex justify-content-center p-4 mt-4">
        <div class="bg-white rounded shadow-sm p-4" style="width: 100%; max-width: 1200px;">
            ...
            <form id="renstra-form" method="POST"
                action="<?= base_url('adminopd/renstra/update-tujuan/' . $tujuan['id']) ?>">
                ...
                <section class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <select name="rpjmd_sasaran_id" id="rpjmd_sasaran_select" class="form-select select23"
                                required>
                                ...
                                <?php if (!empty($rpjmd_sasaran)): ?>
                                    <?php foreach ($rpjmd_sasaran as $s): ?>
                                        ...
                                        $selected = '';
                                        if (
                                            !empty($tujuan['rpjmd_sasaran_id']) &&
                                            (int) $tujuan['rpjmd_sasaran_id'] === (int) $s['id']
                                        ) {
                                            $selected = 'selected';
                                        }
                                        ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tujuan_renstra" id="tujuan_renstra_input" class="form-control mb-3"
                                value="<?= esc($tujuan['tujuan'] ?? '') ?>" placeholder="Ketik tujuan renstra" required
                                autocomplete="off">
                            ...
                            <?php foreach ($indikator_tujuan as $idx => $it): ?>
                                <div class="indikator-tujuan-item border rounded p-3 bg-light mb-3" data-indeks="<?= $idx ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="indikator_tujuan[<?= $idx ?>][indikator_tujuan]" class="form-control"
                                            rows="2" required><?= esc($it['indikator_tujuan'] ?? '') ?></textarea>
                                    </div>
                                                    ...
                                                    <div class="target-item row g-2 align-items-center mb-2">
                                                        <div class="col-auto">
                                                            <input type="number"
                                                                ...
                                                                style="width: 80px;" value="<?= esc($t['tahun'] ?? '') ?>" readonly>
                                                        </div>
                                                        <div class="col">
                                                            <input type="text"
                                                                name="indikator_tujuan[<?= $idx ?>][target_tahunan][<?= $tIndex ?>][target_tahunan]"
                                                                class="form-control form-control-sm"
                                                                value="<?= esc($t['target_tahunan']) ?>" placeholder="Target">
                                                        </div>
                                                    </div>
                                                <?php endforeach;
                                            else:
                                    ...
                                    <div class="target-container">
                                        <?php for ($i = 0; $i < 5; $i++): ?>
                                            <div class="target-item row g-2 align-items-center mb-2">
                                                <div class="col-auto">
                                                    <input type="number"
                                                        name="indikator_tujuan[0][target_tahunan][<?= $i ?>][tahun]"
                                                        class="form-control form-control-sm tahun-target-tujuan"
                                                        style="width: 80px;" readonly>
                                                </div>
                                                <div class="col">
                                                    <input type="text"
                                                        name="indikator_tujuan[0][target_tahunan][<?= $i ?>][target]"
                                                        class="form-control form-control-sm" placeholder="Target">
                                                </div>
                                            </div>
                                        <?php endfor; ?>
                            ...
                            <div class="sasaran-renstra-item border rounded p-3 mb-3" data-sasaran-index="<?= $sIndex ?>">
                                ...
                                <div class="indikator-sasaran-section">
                                    ...
                                    <div class="indikator-sasaran-container"
                                        data-next-indikator-index="<?= count($sr['indikator']) ?>">
                                        ...
                                        <?php foreach ($sr['indikator'] as $iIdx => $ind): ?>
                                            ...
                                            <div class="indikator-sasaran-item border p-3 mb-3">
                                                ...
                                                <?php if (!empty($ind['targets'])): ?>
                                                    <?php foreach ($ind['targets'] as $tIdx => $t): ?>
    ...
    `;
      ...
      <div class="indikator-sasaran-item border rounded p-3 bg-white mb-3" data-indeks="${iIndex}">
        ...
        <div class="mb-3">
          ...
          <input type="hidden"
            name="sasaran_renstra[${sIndex}][indikator_sasaran][${iIndex}][id]"
            value="">
