  ...
  <div>
    ...
    <nav class="p-3">
      <div class="d-grid gap-2">
        ...
        <a href="<?= base_url('adminopd/iku_opd') ?>" class="btn btn-outline-secondary text-start px-3 py-2 text-dark border-0 rounded sidebar-nav-link">IKU OPD</a>
        <a href="<?= base_url('adminopd/pk_opd') ?>" class="btn btn-outline-secondary text-start px-3 py-2 text-dark border-0 rounded sidebar-nav-link">PK OPD</a>
        <a href="<?= base_url('adminopd/kegiatan_pk') ?>" class="btn btn-outline-secondary text-start px-3 py-2 text-dark border-0 rounded sidebar-nav-link">Daftar Kegiatan OPD</a>
