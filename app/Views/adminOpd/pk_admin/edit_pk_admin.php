    ...
    <div id="main-content" class="content-wrapper d-flex flex-column" style="transition: margin-left 0.3s ease;">
        ...
        <main class="flex-fill d-flex justify-content-center p-4 mt-4">
            <div class="bg-white rounded shadow-sm p-4" style="width: 100%; max-width: 1200px;">
                ...
                <form id="rpjmd-form" method="POST" action="<?= base_url('adminopd/pk_administrator/update/' . $pk['pk_id']) ?>">
                    <?= csrf_field() ?>
                    ...
                    <section class="mb-4">
                        ...
                        <div class="col">
                            ...
                            <select name="jenis" id="jenis-pk" class="form-select mb-3 border-secondary" disabled>
                                <option value="administrator"<?= (isset($pk['jenis']) && $pk['jenis'] == 'administrator') ? ' selected' : '' ?>>PK Administrator</option>
                            </select>
                                                    ...
                                                    <div class="indikator-item border rounded p-3 bg-light mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                ...
                                                                <input type="text" name="sasaran_pk[<?= $si ?>][indikator][<?= $ii ?>][indikator]" class="form-control mb-3 border-secondary" value="<?= esc($indikator['indikator']) ?>" required>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="form-label">Target</label>
                                                                <input type="text" name="sasaran_pk[<?= $si ?>][indikator][<?= $ii ?>][target]" class="form-control mb-3 border-secondary" value="<?= esc($indikator['target']) ?>" required>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="form-label">Satuan</label>
                                                                <select name="sasaran_pk[<?= $si ?>][indikator][<?= $ii ?>][id_satuan]" class="form-select mb-3 border-secondary" required>
                                                                    <option value="">Pilih Satuan</option>
                                                                    <?php foreach ($satuan as $s) : ?>
                                                                        <option value="<?= $s['id'] ?>" <?= (isset($indikator['id_satuan']) && $indikator['id_satuan'] == $s['id']) ? 'selected' : '' ?>><?= esc($s['satuan']) ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <select name="program[<?= $pi ?>][program_id]" class="form-select program-select mb-3" required>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="program[<?= $pi ?>][anggaran]" class="form-control mb-3 border-secondary" value="<?= isset($prog['anggaran']) ? esc($prog['anggaran']) : '' ?>" placeholder="Anggaran" required readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="<?= base_url('adminopd/pk/administrator') ?>" class="btn btn-secondary">
