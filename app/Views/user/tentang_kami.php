...
<head>
  ...
  <title>Tentang Kami - <?= esc(setting('app_name', 'e-SAKIP')) ?></title>
...
<body class="bg-light min-vh-100 d-flex flex-column position-relative">
  ...
  <main class="flex-grow-1 my-4 my-md-5">
      ...
      <div class="bg-white rounded shadow-sm p-4">
        ...
        <div class="tk-hero">
          <span class="tk-logo-wrap">
            <img src="<?= base_url(setting('app_logo', 'assets/images/LogoTentang.png')) ?>" alt="Logo <?= esc(setting('app_name', 'AKSARA')) ?>">
          </span>
          <h2 class="h3 fw-bold">Tentang AKSARA</h2>
          <p>Akuntabilitas Sistem Kinerja Aparatur &mdash; <?= esc(setting('instansi', 'Kabupaten Pringsewu')) ?></p>
        </div>
