                ...
                foreach ($data['tujuan'] as $tujuanData) {
                    ...
                    if (isset($tujuanData['indikator_tujuan']) && is_array($tujuanData['indikator_tujuan'])) {
                        foreach ($tujuanData['indikator_tujuan'] as $indikatorTujuan) {
                            ...
                            if (isset($indikatorTujuan['target_tahunan_tujuan']) && is_array($indikatorTujuan['target_tahunan_tujuan'])) {
                                foreach ($indikatorTujuan['target_tahunan_tujuan'] as $target) {
                                    $target['indikator_tujuan_id'] = $indikatorTujuan;
